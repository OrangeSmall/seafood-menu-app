...
def check_password():
    ...
    if "app_password" in st.secrets:
        ...
        st.error("⚠️ 請先在 Secrets 設定 app_password")
        return False
...
def create_image(data_df, date_str, manual_upload=None):
    ...
    draw.text((width - margin - 500, 180), "※ 若特殊情況依現場主管判斷為主", fill="#F0E68C", font=font_date)
    ...
    draw.text((margin, footer_y + 30), "Generated by SmallOrange seafood bot V5.1", fill="#CCCCCC", font=font_footer)
    return img
        ...
        if selected_item and selected_spec:
            ...
            if not target_row.empty:
                ...
                if chart_data:
                    ...
                    st.bar_chart(chart_df, color="#C19A6B") 
